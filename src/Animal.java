...
public abstract class Animal extends Organism implements LivingBeing {
    ...
    public void action() {
        ...
        final int newX;
        final int newY;
        String log = "Zwierzę (" + this.x + "," + this.y + ") " + this.getName() + " idzie na ";
    ...
    public boolean collision(LivingBeing other) {
        ...
        if (other.getClass() == this.getClass()) {
            ...
            log = "Kolizja zwięrząt (" + this.x + "," + this.y + ") i " + " (" + other.getX() + "," + other.getY() + ") " + "tego samego gatunku, ";
            if (tryMultiply) {
            ...
            if (this.strength > other.getStrength()) {
                log += "Atakujące zwierzę \"" + this.getName() + " (" + this.x + "," + this.y + ") " + "\" wygrywa! " + other.getName()+" umiera";
                other.setToDelete();
            } else {
                log += "Atakujące zwierzę \"" + other.getName() + " (" + other.getX() + "," + other.getY() + ") " + "\" wygrywa! Zwierze " + this.getName() + " (" + this.x + "," + this.y + ") " + " umiera";
                this.toDelete = true;
            }
            this.world.consoleLogLn(log);
            return true;
